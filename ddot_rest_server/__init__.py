...
NETATTRIB_PARAM = 'networkattributes'
...
class RunOntology(Resource):
    ...
    post_parser.add_argument(HIVIEWURL_PARAM,
                             ...
                             help='HiView server',
                             location='form')
    post_parser.add_argument(NETATTRIB_PARAM, type=str,
                             help='Updates network attributes for base '
                                  'network generated by DDOT. '
                                  'This field should be set as a json string '
                                  'in CX format for network attributes '
                                  '[{"n": "attrib name", '
                                  '"v": <attrib value>, "d": "string"}]" '
                                  'WARNING: name, description, and version '
                                  'CANNOT be updated this way and'
                                  ' will be ignored',
                             location='form')
